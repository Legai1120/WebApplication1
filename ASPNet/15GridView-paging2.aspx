<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="15GridView-paging2.aspx.cs" Inherits="ASPNet._15GridView_paging2" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" AllowPaging="true" PageSize="2" OnDataBound="GridView1_DataBound">
