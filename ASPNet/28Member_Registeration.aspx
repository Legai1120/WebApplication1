<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="28Member_Registeration.aspx.cs" Inherits="ASPNet._28Member_Registeration" %>
        ...
        <div>
            ...
            <table id="tbMember">
                    ...
                    <td>
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                ...
                                <asp:Button ID="Button2" runat="server" Text="檢查帳號可用性" ValidationGroup="abc123"/>
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="txtAccount" Display="Dynamic" ValidationExpression="[A-Za-z0-9]{10}" runat="server" ErrorMessage="(格式有誤)" ForeColor="Red" Font-Size="10pt"></asp:RegularExpressionValidator>
                                <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="(帳號重複)" OnServerValidate="CustomValidator1_ServerValidate" ValidationGroup="abc123" ForeColor="Red" Font-Size="10pt"></asp:CustomValidator>
                             </ContentTemplate>
                        </asp:UpdatePanel>
                    </td>
                </tr>
                ...
                <tr>
                    <td>備註：</td>
                    <td>
                        <asp:TextBox ID="txtNote" runat="server" TextMode="MultiLine" Width="200" Height="150"></asp:TextBox>
                         <asp:CompareValidator ID="CompareValidator4" runat="server" Operator="NotEqual" ValueToCompare="請選擇"  ControlToValidate="ddlEduLevel" ErrorMessage="(請選擇)" ForeColor="Red" Font-Size="10pt"></asp:CompareValidator>
                    </td>
                 </tr>
