<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="22DataList-Edit.aspx.cs" Inherits="ASPNet._22DataList_Edit" %>
       ...
       <div>
            ...
            <EditItemTemplate>
             ...
             <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="SELECT * FROM [Products]" UpdateCommand="update Products set product_Name=@Product_Name,Product_Price=@Product_Price, 
